...
export default function SubNavBar({ context }) {
  ...
  return (
    <nav className="av-subnav">
      {/* Vùng trái: Logo & Menu chữ in hoa */}
      ...
      {/* Vùng phải: Icon MXH, Chuông, Avatar & Nút Lên Đầu Trang */}
      <div className="av-right">
        <a href="https://github.com" target="_blank" rel="noreferrer" className="av-social-btn" title="GitHub">
